<footer class="full-row bg-secondary p-0">
            <div class="container">
                                    ...
                                    <div class="footer-widget mb-4">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>27 Bungalow Street, Salem, TamilNadu</li>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Real Estate Website - Developed by Gayathiri</span> </div>
                    <div class="col-sm-6">
